            ...
            mHandler.post(new Runnable() {
                public void run() {
                    ...
                    if (mChecksInProgress.contains(mValidator)) {
						...
						if(signedData == null || mPublicKey==null || signature==null)
						{
							//Seemingly can occasionally get into this situation if there isn't an account logged into the Play Store
							if(signedData==null)
								 Log.i(TAG, "Verifying licence error:signedData is null");
						
							if(mPublicKey==null)
								 Log.i(TAG, "Verifying licence error:mPublicKey is null");
											
							if(signature==null)
								 Log.i(TAG, "Verifying licence error:signature is null");
						}
						else						
						{
