...
public class Helpers {
     ...
     */
     static public String generateSaveFileName(Context c, String fileName) {
      ...
      //  Log.i("yoyo","Generated path " + path + " from input fileName:" + fileName);
        return path;
    }
    ...
    static public String getSaveFilePath(Context c) {
        ...
        if(obb.exists())
        {
			String path2 = obb+File.separator;
			Log.i("yoyo","Using obb path: " + path2);
			
			return path2;
        }
        
        Log.i("yoyo","Unable to find obb dir so using " + path);
