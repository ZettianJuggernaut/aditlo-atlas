...
if(vspeed == 0)
{
	...
	if(image_index == 0 && instance_exists(obj_halo_black))
	{
		ds_list_delete(global.list_token_frozen,ds_list_find_index(global.list_token_frozen,0));
		if(ds_list_find_index(global.list_token_black,obj_sequence_current.image_index) > 0 && ds_list_find_index(global.list_token_frozen,0) == -1)
		{
			if(ds_list_find_index(global.list_token_frozen,obj_sequence_current.image_index) != -1)
			{
				ds_list_delete(global.list_token_frozen,ds_list_find_index(global.list_token_frozen,obj_sequence_current.image_index));
			}
		}
		if(ds_list_find_index(global.list_token_black,obj_sequence_current.image_index) > -1 && ds_list_find_index(global.list_token_frozen,0) == -1)
		{
			with(instance_nearest(obj_sequence_current_sm.x,obj_sequence_current_sm.y,obj_halo_black))
			{
				instance_destroy();
			}
	...
	else if(image_index == 1 && instance_exists(obj_halo_blue))
	{
		ds_list_delete(global.list_token_frozen,ds_list_find_index(global.list_token_frozen,1));
		if(ds_list_find_index(global.list_token_blue,obj_sequence_current.image_index) > 0 && ds_list_find_index(global.list_token_frozen,1) == -1)
		{
			if(ds_list_find_index(global.list_token_frozen,obj_sequence_current.image_index) != -1)
			{
				ds_list_delete(global.list_token_frozen,ds_list_find_index(global.list_token_frozen,obj_sequence_current.image_index));
	...
	else if(image_index == 2 && instance_exists(obj_halo_green))
	{
		...
		if(ds_list_find_index(global.list_token_green,obj_sequence_current.image_index) > 0 && ds_list_find_index(global.list_token_frozen,2) == -1)
		{
			if(ds_list_find_index(global.list_token_frozen,obj_sequence_current.image_index) != -1)
			{
				ds_list_delete(global.list_token_frozen,ds_list_find_index(global.list_token_frozen,obj_sequence_current.image_index));
	...
	else if(image_index == 3 && instance_exists(obj_halo_red))
	{
		...
		if(ds_list_find_index(global.list_token_red,obj_sequence_current.image_index) > 0 && ds_list_find_index(global.list_token_frozen,3) == -1)
		{
			if(ds_list_find_index(global.list_token_frozen,obj_sequence_current.image_index) != -1)
			{
				ds_list_delete(global.list_token_frozen,ds_list_find_index(global.list_token_frozen,obj_sequence_current.image_index));
	...
	else if(image_index == 4 && instance_exists(obj_halo_white))
	{
		...
		if(ds_list_find_index(global.list_token_white,obj_sequence_current.image_index) > 0 && ds_list_find_index(global.list_token_frozen,4) == -1)
		{
			if(ds_list_find_index(global.list_token_frozen,obj_sequence_current.image_index) != -1)
			{
				ds_list_delete(global.list_token_frozen,ds_list_find_index(global.list_token_frozen,obj_sequence_current.image_index));
	...
	else if(image_index == 5 && instance_exists(obj_halo_yellow))
	{
		...
		if(ds_list_find_index(global.list_token_yellow,obj_sequence_current.image_index) > 0 && ds_list_find_index(global.list_token_frozen,5) == -1)
		{
			if(ds_list_find_index(global.list_token_frozen,obj_sequence_current.image_index) != -1)
			{
				ds_list_delete(global.list_token_frozen,ds_list_find_index(global.list_token_frozen,obj_sequence_current.image_index));
